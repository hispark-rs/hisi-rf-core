...
- Added resource-owner and largest-contiguous-allocation diagnostics for
  actionable, group-aware startup admission failures.
...
- Added current and high-water occupancy to blocking-runner diagnostics for
  the fixed-capacity control command channel.

## [0.1.0-alpha.12] - 2026-07-23

### Added

- Added blocking-runner work counters and event-queue high-water diagnostics so
  chip adapters can capture a measured migration baseline before replacing the
  validated blocking backend.
